...
\section{Опыт работы}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Сервис оптимизации логистики:} в составе команды разработал систему для снижения 8--12-часового простоя локомотивов на сети из 1000+ станций для крупного акционерного общества (участника процесса IPO). Реализовал алгоритм автоподбора оптимальных кандидатов к 90 локомотивам.}
    ...
    \resumeSubheading
      {ИП Чалов}{Казахстан}
      {Главный технический специалист}{Июнь 2026 -- Сент. 2026}
      \resumeItemListStart
    ...
    \resumeSubheading
      {ТОО <<Wipon>> (Вайпоинг)}{Казахстан}
      {Data Scientist and Machine Learning Engineer (стажировка)}{Сент. 2026 -- 15 Дек. 2026}

    \resumeSubheading
      {ТОО Tirek Systems and Solutions}{Казахстан}
      {CTO, сооснователь}{Дек. 2024 -- Авг. 2026}
      \resumeItemListStart
...
\section{Технические навыки}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Базы данных \& Аналитика}{: PostgreSQL, Power BI, Tableau} \\
     \textbf{ML \& AI-системы}{: Multi-Agent Systems, LLM, XGBoost} \\
     \textbf{DevOps \& Cloud}{: Linux (Ubuntu/Debian), Google Cloud Platform, Kubernetes (k3s), Микросервисы, Docker, CI/CD (GitHub Actions, GitLab CI), Cloudflare Workers, Cloudflare Tunnel, Cloudflare DNS, Cloudflare Analytics} \\
     \textbf{Инструменты \& Геоданные}{: Git / GitHub / GitLab (контроль версий), OpenStreetMap / OSM (геоданные), LaTeX (документация), TikZ (визуализация, схематика), Figma (UI-макеты)} \\
